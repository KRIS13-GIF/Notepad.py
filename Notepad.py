...
top=Frame(canvas) # this frame creates the function that a grid does
...
entry=Text(canvas,wrap=WORD, bg="#F9DDA4", font=("poppins",15)) # wrap is used to write the senteces without interruptions
